...
import { MediaFile } from '@/types/catalog';
            ...
            >
              ...
              <div className="absolute top-0 left-0 right-0 z-20 bg-gradient-to-b from-black/80 to-transparent p-6 w-full">
                <div className="flex items-center justify-between">
                  <div className="text-white">
                    ...
                    <p className="text-white/80">
                      {images[selectedImage].description || `Фото ${selectedImage + 1} из ${images.length}`}
                    </p>
                  </div>
               ...
               >
                 <motion.img
                   key={selectedImage}
                   src={images[selectedImage].file_url || images[selectedImage].url}
                   alt={images[selectedImage].description || `${title} - фото ${selectedImage + 1}`}
