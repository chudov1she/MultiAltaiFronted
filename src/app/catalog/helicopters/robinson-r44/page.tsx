            ...
            >
              ...
              >
                ...
                <div className="space-y-4 text-gray-700">
                    ...
                    <p className="leading-relaxed">
                      Премиальное оборудование включает две гарнитуры Bose для комфортного общения, радиовысотометр для повышения безопасности полётов, дополнительные баки на 120 литров для значительного увеличения дальности полёта и буксировочные колёса для удобства наземного перемещения.
                    </p>
